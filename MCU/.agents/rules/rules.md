...
- Safety: Always bounds-check arrays, NULL-check pointers, race-condition check. Full cleanup on deinit (disable modules, reset GPIOs, free ISRs).

# Hardware, Clock & Peripherals
