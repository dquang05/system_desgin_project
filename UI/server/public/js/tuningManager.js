        ...
        try {
            ...
            if (obj.pid) {
                ...
                if (!this.initializedInputs) {
                    ...
                    if (this.inputEls.kpL) this.inputEls.kpL.value = this.currentPid.L[0].toFixed(3);
                    if (this.inputEls.kiL) this.inputEls.kiL.value = this.currentPid.L[1].toFixed(3);
                    if (this.inputEls.kdL) this.inputEls.kdL.value = this.currentPid.L[2].toFixed(3);

                    if (this.inputEls.kpR) this.inputEls.kpR.value = this.currentPid.R[0].toFixed(3);
                    if (this.inputEls.kiR) this.inputEls.kiR.value = this.currentPid.R[1].toFixed(3);
                    if (this.inputEls.kdR) this.inputEls.kdR.value = this.currentPid.R[2].toFixed(3);

                    if (this.inputEls.kpT) this.inputEls.kpT.value = this.currentPid.T[0].toFixed(3);
                    if (this.inputEls.kiT) this.inputEls.kiT.value = this.currentPid.T[1].toFixed(3);
